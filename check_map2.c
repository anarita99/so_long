...
/*   Updated: 2025/07/22 11:05:37 by adores           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	diff_characters(char **mapcopy)
{
	int	x;
	int	y;
	...
	while (mapcopy[y])
	{
		...
		while (mapcopy[y][x])
		{
			if (mapcopy[y][x] != 'C' && mapcopy[y][x] != 'E'
			&& mapcopy[y][x] != '1' && mapcopy[y][x] != '0'
			&& mapcopy[y][x] != 'P' && mapcopy[y][x] != '\n')
				return (0);
			x++;
		}
		y++;
